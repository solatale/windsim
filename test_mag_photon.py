...
if __name__ == '__main__':
    ...
    for scheme_i in range(1):
        ...
        # print(magab_ener_zeros)
        # print(magab_phot_zeros)
    ...
    result = ascii.read(OutCssCatName)
    mageng_mod_r = result['Mag_enr_r'] - result['MOD_r']
    magpht_mod_r = result['Mag_pht_r'] - result['MOD_r']
    print('Energy:',np.mean(mageng_mod_r), np.std(mageng_mod_r))
    print('Photon:',np.mean(magpht_mod_r), np.std(magpht_mod_r))
