...
if __name__ == '__main__':
    ...
    for scheme_i in [1]:#range(3):
        ...
        for i in range(len(CatOfTile)):
            ...
            ObjWinPhot.Centract(idt=str(outcatrowi[0])+" ConvWdW", thresh=2, deblend_nthresh=32, deblend_cont=0.1, minarea=10, debug=DebugTF)
            ...
            if DebugTF == True:
                ...
                print('self.bkg Flux & ErrFlux =', ObjWinPhot.bkg.globalback, ObjWinPhot.bkg.globalrms)
            ...
            if DebugTF == True:
                ...
                # WinImgBands32 = np.array(WinImgBands, dtype='float32')
                csstpkg.DataArr2Fits(WinImgBands, ident+'_allbands.fits')
            ...
            StackPhot.Centract(idt=str(outcatrowi[0]) + " Stack", thresh=1.2, minarea=10,)
            ...
            if AduStack is np.nan:
                ...
                for cssband, numb in zip(cssbands, filtnumb):
                    ...
                    AduObser, ErrAduObs = csstpkg.septractSameAp(WinImgBands[bandi,::], StackPhot.centobj, StackPhot.kronr, mask_det=StackPhot.maskarr, debug=DebugTF, annot=cssband, thresh=1.2, minarea=10)
